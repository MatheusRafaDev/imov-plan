  ...
  return (
    <div className="space-y-4 relative w-full">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className={`bg-card custom-scrollbar -mx-4 sm:-mx-6 md:-mx-8 lg:mx-0 lg:rounded-xl lg:shadow-sm border-y sm:border border-border/40 transition-opacity duration-300 overflow-x-auto lg:overflow-x-visible ${calculating ? "opacity-60 pointer-events-none" : "opacity-100"}`}>
          <TableVirtuoso
